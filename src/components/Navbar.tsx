  ...
  return (
    <>
      ...
      >
                  ...
                  {profileOpen && (
                    ...
                    >
                      <div
                        ...
                        style={{ borderBottom: "1px solid rgba(0,245,212,0.15)" }}
                      >
                        ...
                        <div>
                          ...
                          <div className="text-xs text-primary font-body mt-0.5">
                            Age {session.age} · {session.diabetesType}
                          </div>
                        </div>
                      </div>
        ...
        {mobileOpen && session && (
          <div
            className="md:hidden glass-card p-4 mx-4 mb-2 mt-1"
          ...
          >
            ...
            <div
              className="mt-3 pt-3"
              style={{ borderTop: "1px solid rgba(0,245,212,0.15)" }}
            >
              <div className="text-xs text-foreground/40 font-body mb-2">
                {session.fullName} · Age {session.age}
              </div>
              <button
                onClick={toggle}
                className="block w-full text-left py-2 text-sm text-foreground/70 hover:text-primary transition-colors"
              >
                {theme === "dark" ? "☀️ Light Mode" : "🌙 Dark Mode"}
              </button>
              <button onClick={handleLogout} className="mt-1 text-sm text-destructive">
                Logout
              </button>
            </div>
          </div>
      ...
      <QuickLogModal
        open={mealLogOpen}
        onClose={() => { setMealLogOpen(false); refreshNotifs(); }}
      />
    </>
  );
}
